...
const Searchbar = () => {
    ...
    const onTypeChange = async e => {
        ...
        let bed = document.querySelector("select[name='no_of_bedrooms']")
        let bath = document.querySelector("select[name='no_of_bathrooms']")
        if (type === "Plot") {
            bed.value = ""
                ...
                <div className="Searchbar">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div>
                                <select onChange={onTypeChange} name="type" id="type">
